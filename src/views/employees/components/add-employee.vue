<template>
  <el-dialog title="新增员工" :visible="showDialog" @close="handleClose">
    <!-- 表单 -->
    <el-form ref="addEmployee" :model="formData" :rules="rules" label-width="120px">
      ...
      <el-form-item label="部门" prop="departmentName">
        ...
        <el-tree v-show="isShow" v-loading="loading" :data="treeData" :default-expand-all="true" :props="{ label: 'name' }" @node-click="selectNode" />
      </el-form-item>
